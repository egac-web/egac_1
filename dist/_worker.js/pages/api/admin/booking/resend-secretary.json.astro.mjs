...
import { e as getBookingById, a as getSupabaseAdmin, b as appendEnquiryEvent } from '../../../../chunks/supabase_BK1iFgLr.mjs';
import { sendBookingConfirmationNotification } from '../../../../chunks/notifications_DQEtDqdD.mjs';
...
async function POST({ request, locals }) {
  ...
  try {
    ...
    try {
      ...
      if (reqToken === "dev") {
        return new Response(JSON.stringify({ ok: false, error: "exception", details: String(err), stack: err?.stack || null }), { status: 500, headers: { "Content-Type": "application/json" } });
      }
