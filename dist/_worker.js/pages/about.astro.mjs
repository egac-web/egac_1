...
import { e as createAstro, f as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead, l as renderScript, u as unescapeHTML } from '../chunks/astro/server_BcA0Y13i.mjs';
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    ...
    feesArticlesHtml = aboutArticles.filter((a) => a.slug === "membership-fees").map((article) => {
