...
const $$U20 = createComponent(async ($$result, $$props, $$slots) => {
  let records = [];
  try {
    if (directus) {
      records = await directus.request(
        n("records", {
          filter: { ageGroup: { _eq: "u20" } },
...
}, "/home/eddie/athletics/egac_1/src/pages/records/u20.astro", void 0);

const $$file = "/home/eddie/athletics/egac_1/src/pages/records/u20.astro";
const $$url = "/records/u20";
