...
const $$U11 = createComponent(async ($$result, $$props, $$slots) => {
  let records = [];
  try {
    if (directus) {
...
}, "/home/eddie/athletics/egac_1/src/pages/records/u11.astro", void 0);

const $$file = "/home/eddie/athletics/egac_1/src/pages/records/u11.astro";
const $$url = "/records/u11";
