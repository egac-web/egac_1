...
const $$U15 = createComponent(async ($$result, $$props, $$slots) => {
  let records = [];
  try {
    if (directus) {
      const response = await directus.items("records").readMany({
        filter: { ageGroup: { _eq: "u15" } },
...
}, "/home/eddie/athletics/egac_1/src/pages/records/u15.astro", void 0);

const $$file = "/home/eddie/athletics/egac_1/src/pages/records/u15.astro";
const $$url = "/records/u15";
