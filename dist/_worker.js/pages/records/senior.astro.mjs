...
const $$Senior = createComponent(async ($$result, $$props, $$slots) => {
  let records = [];
  try {
    if (directus) {
      const response = await directus.items("records").readMany({
        filter: { ageGroup: { _eq: "senior" } },
...
Records for Senior age group
</p> <div <div class="card" style="overflow:hidden;">
>
...
}, "/home/eddie/athletics/egac_1/src/pages/records/senior.astro", void 0);

const $$file = "/home/eddie/athletics/egac_1/src/pages/records/senior.astro";
const $$url = "/records/senior";
