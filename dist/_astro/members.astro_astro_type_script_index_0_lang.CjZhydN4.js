const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/TemplateEditor.BgM0d-zV.js","_astro/jsx-runtime.D_zvdyIk.js","_astro/index.CT7zvmi-.js","_astro/index.B0_VcSax.js","_astro/index.CjfU_FF1.js","_astro/client.Dcn0vcCG.js"])))=>i.map(i=>d[i]);
const J="modulepreload",R=function(e){return"/"+e},N={},M=function(n,i,t){let o=Promise.resolve();if(i&&i.length>0){let a=function(d){return Promise.all(d.map(l=>Promise.resolve(l).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=r?.nonce||r?.getAttribute("nonce");o=a(i.map(d=>{if(d=R(d),d in N)return;N[d]=!0;const l=d.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":J,l||(p.as="script"),p.crossOrigin="",p.href=d,c&&p.setAttribute("nonce",c),document.head.appendChild(p),l)return new Promise((h,$)=>{p.addEventListener("load",h),p.addEventListener("error",()=>$(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return o.then(a=>{for(const r of a||[])r.status==="rejected"&&s(r.reason);return n().catch(s)})};function U(e){try{return!e||!e.trim()?{ok:!0,vars:{}}:{ok:!0,vars:JSON.parse(e)}}catch(n){return{ok:!1,error:n.message}}}function F(e=""){return String(e||"").replace(/<\/?(p|div|br|h[1-6]|li)[^>]*>/gi,`
