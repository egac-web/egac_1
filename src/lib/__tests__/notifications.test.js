...
describe('Email Template Rendering', () => {
  ...
  it('should render invite email template correctly and contain CTA and footer', () => {
    const template = '<div><h1>Book your free taster</h1><a class="cta" href="{{inviteUrl}}">Book a session</a><div class="footer">{{siteName}}</div></div>';
    const vars = {
    ...
    expect(result).toContain('East Grinstead AC');
  });
